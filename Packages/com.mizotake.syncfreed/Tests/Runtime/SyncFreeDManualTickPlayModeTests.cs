...
{
    public sealed class SyncFreeDManualTickPlayModeTests
    {
        [UnityTest]
        public IEnumerator ManualTick_ProducesStateWhenOutputTickModeIsManual()
        {
            var cameraObject = new GameObject("SyncFreeD Manual Tick Camera");
