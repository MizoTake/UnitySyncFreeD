...
namespace MizoTake.SyncFreeD.UnityAdapters.Behaviours
{
    ...
    public sealed class SyncDiagnosticsBehaviour : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            var destinationText = output != null && logLevel >= SyncLogLevel.Verbose ? string.Format(CultureInfo.InvariantCulture, " DestSpreadUs {0} Dest {1}", output.LastDestinationSpreadMicroseconds, output.LastDestinationDiagnostics.Length) : string.Empty;
