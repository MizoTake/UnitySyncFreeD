...
namespace MizoTake.SyncFreeD.UnityAdapters.Behaviours
{
    ...
    public sealed class SyncDiagnosticsBehaviour : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            var packetText = output != null && logLevel >= SyncLogLevel.Packet ? string.Format(CultureInfo.InvariantCulture, " Ck {0:X2} Ua {1:X4} Sent {2} Fail {3}", output.LastChecksum, output.LastUserArea, output.LastSendSuccessCount, output.TotalSendFailureCount) : string.Empty;
